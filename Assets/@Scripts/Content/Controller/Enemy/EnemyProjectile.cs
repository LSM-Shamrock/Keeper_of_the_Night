...
public abstract class EnemyProjectile : BaseController
{
    ...
    protected void DestroyThisClone() => Manager.Object.Despawn(gameObject);
    public virtual void OnCreate(Vector3 position, Vector3 direction)
    {
        ...
        StartCoroutine(StartContactCharacter());
    }
    protected abstract IEnumerator StartShoot();
    protected virtual IEnumerator StartContactCharacter()
    {
        yield return null;
    }
}
